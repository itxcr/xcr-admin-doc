...
项目的环境变量配置位于项目根目录下的 [.env](https://github.com/itxcr/xcr-admin/blob/master/.env)、[.env.development](https://github.com/itxcr/xcr-admin/blob/master/.env.development)、[.env.production](https://github.com/itxcr/xcr-admin/blob/master/.env.production)
...
在 [/@/settings/encryptionSetting.ts](https://github.com/itxcr/xcr-admin/blob/master/src/settings/encryptionSetting.ts) 内可以配置 `localStorage` 及 `sessionStorage` 缓存信息

**前提:** 使用项目自带的缓存工具类 [/@/utils/cache](https://github.com/itxcr/xcr-admin/blob/master/src/utils/cache/index.ts) 来进行缓存操作
...
- 在 [src/settings/designSetting.ts](https://github.com/itxcr/xcr-admin/blob/master/src/settings/designSetting.ts) 内配置

```ts
export const prefixCls = 'vben';
```

- 在 [src/design/var/index.less](https://github.com/itxcr/xcr-admin/blob/master/src/design/var/index.less) 配置 css 前缀
