...
```bash
# 拉取代码
git clone https://github.com/itxcr/xcr-admin-doc
...
- [xcr-admin](https://github.com/itxcr/xcr-admin)

该版本主要是提供一些 `Demo` 示例及插件的使用集成方式，主要用于参考。
