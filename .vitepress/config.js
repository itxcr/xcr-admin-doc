...
module.exports = {
  ...
  head: createHead(),
  themeConfig: {
    repo: 'itxcr/xcr-admin',
    docsRepo: 'itxcr/xcr-admin-doc',
    logo: '/logo.png',
    docsBranch: 'main',
    editLinks: true,
...
function createHead() {
  return [
    ['meta', { name: 'author', content: 'xcr' }],
    [
      'meta',
      {
        name: 'keywords',
        content: 'xcr, vitejs, vite, ant-design-vue, vue',
      },
    ],
    ...
    ['meta', { name: 'keywords', content: 'xcr admin docs' }],
  ...
  return [
    ...
    },
    {
      ...
      items: [
        {
          text: '完整版预览',
          link: 'https://itxcr.com/admin/',
        },
        {
          text: '完整版源码',
          link: 'https://github.com/itxcr/xcr-admin',
        },
        {
          text: '文档源码',
          link: 'https://github.com/itxcr/xcr-admin-doc',
        },
      ],
    },
    // {
